...
export default function ResetPasswordPage() {
  ...
  const btnCls   = 'w-full rounded-lg bg-pantheon-yellow px-4 py-2.5 font-mono text-sm font-semibold text-black hover:bg-pantheon-yellow-dark transition-colors disabled:opacity-50'
